...
(function ($) {
    ...
    var DISPLAYTMPL = ['<div class="ridisplay">',
        '<div class="rimain">',
            ...
            '{{if !readOnly}}',
                '<a href="#" class="btn btn-small" name="riedit">${i18n.edit}</a>',
            '{{/if}}',
        '</div>',
    ...
    var FORMTMPL = ['<div class="riform">',
            '<form>',
                ...
                '</div>',
                '<div id="rirtemplate">',
                    '<label for="${name}rtemplate" class="labelRecurrence">',
                        '${i18n.recurrenceType}',
                    '</label>',
                ...
                '<div id="riformfields">',
                    '<div id="ridailyinterval" class="rifield">',
                        '<label for="${name}dailyinterval" class="labelRecurrence">',
                            '${i18n.dailyInterval1}',
                        '</label>',
                        '<div class="field">',
                    ...
                    '<div id="riweeklyinterval" class="rifield">',
                        '<label for="${name}weeklyinterval" class="labelRecurrence">',
                    ...
                    '<div id="riweeklyweekdays" class="rifield">',
                        '<label for="${name}weeklyinterval" class="labelRecurrence">${i18n.weeklyWeekdays}</label>',
                        '<div class="field">',
                    ...
                    '<div id="rimonthlyinterval" class="rifield">',
                        '<label for="rimonthlyinterval" class="labelRecurrence">${i18n.monthlyInterval1}</label>',
                        '<div class="field">',
                            '<input type="text" size="2"',
                                'value="1" ',
                    ...
                    '<div id="rimonthlyoptions" class="rifield">',
                        '<label for="rimonthlytype" class="labelRecurrence">${i18n.monthlyRepeatOn}</label>',
                        '<div class="field">',
                            '<div>',
                                '<input',
                                    'type="radio"',
                    ...
                    '<div id="riyearlyinterval" class="rifield">',
                        '<label for="riyearlyinterval" class="labelRecurrence">${i18n.yearlyInterval1}</label>',
                        '<div class="field">',
                            '<input type="text" size="2"',
                                'value="1" ',
                    ...
                    '<div id="riyearlyoptions" class="rifield">',
                        '<label for="riyearlyType" class="labelRecurrence">${i18n.yearlyRepeatOn}</label>',
                        '<div class="field">',
                            '<div>',
                                '<input',
                                    'type="radio"',
                    ...
                    '<div id="rirangeoptions" class="rifield">',
                        '<label class="labelRecurrence">${i18n.range}</label>',
                        '<div class="field">',
                            '<div>',
                                '<input',
                                    'type="radio"',
                                ...
                                '<label for="${name}rangetype:NOENDDATE" style="display: inline-block;">',
                                    '${i18n.rangeNoEnd}',
                                '</label>',
                            '</div>',
                            '<div>',
                                ...
                                '<label for="${name}rangetype:BYOCCURRENCES" style="display: inline-block;">',
                            ...
                            '<div>',
                                ...
                                '<label for="${name}rangetype:BYENDDATE" style="display: inline-block;">',
                                    '${i18n.rangeByEndDate}',
                                '</label>',
                                '<input',
                                    'type="date"',
                ...
                '<div class="ributtons">',
                    ...
                    '<input',
                        'type="submit"',
                        'class="btn btn-primary risavebutton ${ributtonExtraClass}"',
                        'value="${i18n.save}" />',
                '</div>',
            '</form></div>'].join('\n');
